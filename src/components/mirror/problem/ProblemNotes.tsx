...
export default function ProblemNotes({ contestId, problemIndex }: ProblemNotesProps) {
    ...
    const storageKey = `verdict-notes-${contestId}-${problemIndex}`;
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(() => {
            ...
            try {
                ...
                // Browsers can disable storage; editing remains available.
            } finally {
                setTimeout(() => setIsSaving(false), 500);
            }
        }, 1500);
        return () => clearTimeout(timer);
    }, [content, storageKey, isLoading]);
